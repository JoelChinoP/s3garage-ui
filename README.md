...
```sh
$ docker run -p 3909:3909 -v ./garage.toml:/etc/garage.toml:ro --restart unless-stopped --name garage-webui safezoneturingpe/garage-webui:latest
```
...
services:
  ...
  webui:
    image: safezoneturingpe/garage-webui:latest
